...
public extension Date {
        ...
        if (iso8601String as NSString) == NSNull() {
            ...
            case 20:
                ...
                if originalString[timeZoneIndicatorIndex] == "Z" {
                    currentString = String(originalString[originalString.startIndex..<timeZoneIndicatorIndex])
                }
            case 22:
                ...
                if originalString[timeZoneColonIndex] == "." {
                    ...
                    currentString = String(originalString[originalString.startIndex..<baseDateIndex])
            ...
            if hasFullTimeZone {
                ...
                var timeZone: String {
                    ...
                    let fullTimeZone = originalString[endIndex..<originalString.endIndex]

                    let replacedString = fullTimeZone.replacingOccurrences(of: ":", with: "")
                ...
                var timeZone: String {
                    ...
                    return String(originalString[endIndex..<originalString.endIndex])
                }
                currentString = currentString.appending(timeZone)
            } else {
            ...
            if hasCentiseconds || hasMiliseconds || hasMicroseconds {
                let trimmedDate = dateString["2015-09-10T00:00:00.".endIndex..<dateString.endIndex]

                if hasCentiseconds {
                    let endIndex = trimmedDate.index(trimmedDate.startIndex, offsetBy: "00".count)
                    let centisecondsString = trimmedDate[trimmedDate.startIndex..<endIndex]
                ...
                if hasMiliseconds {
                    let endIndex = trimmedDate.index(trimmedDate.startIndex, offsetBy: "000".count)
                    let milisecondsString = trimmedDate[trimmedDate.startIndex..<endIndex]
                ...
                if hasMicroseconds {
                    let endIndex = trimmedDate.index(trimmedDate.startIndex, offsetBy: "000000".count)
                    let microsecondsString = trimmedDate[trimmedDate.startIndex..<endIndex]
    ...
    public init(unixTimestampString: String) throws {
        ...
        if unixTimestampString.count > validLength {
            parsedString = String(unixTimestampString[unixTimestampString.startIndex..<validUnixTimestamp.endIndex])
        }
